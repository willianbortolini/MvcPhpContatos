...
class Dao extends Model{    
    public function lista($tabela, $empresa=null){
        return  $this->all($this->db, $tabela, $empresa);
    }    
    
    public function get($tabela, $campo, $valor, $eh_lista, $empresa=null){
        return  $this->find($this->db,$campo, $valor, $tabela, $eh_lista,$empresa);
    } 
    
    public function getSemEmpresa($tabela, $campo, $valor, $eh_lista, $empresa=null){
        return  $this->findSemEmpresa($this->db,$campo, $valor, $tabela, $eh_lista,$empresa);
    }
